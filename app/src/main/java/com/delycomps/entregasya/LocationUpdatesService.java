...
import static com.delycomps.entregasya.Utils.removeLocation;
import static com.delycomps.entregasya.Utils.shareLocation;
...
public class LocationUpdatesService extends Service {
    ...
    private Notification getNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.drawable.logoya, "Dejar de compartir",
                        servicePendingIntent)
                .setContentText("Compartiendo ubicación en tiempo real")
                .setContentTitle("Ubicación en tiempo real de EntregasYa")
                .setOngoing(true)
...
//
        ...
        shareLocation(location, idUser, plateNumber);
        mLocation = location;
